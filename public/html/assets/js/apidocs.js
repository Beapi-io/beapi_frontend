                                                ...
                                                <div class='row panel panel-blue' style='margin-left:0px;margin-right:0px'>
                                                    <div class='col-md-1' style='padding-top:8px;padding-bottom:8px;background-color:`+mthd_clr+`'>`+val3.method+`</div>
                                                        <div class='col-md-5'>
                                                            ...
                                                            <a class='accordion-toggle' data-toggle='collapse' data-parent='#accordion-`+count+`' href='#collapse-`+count+`'>`+path+`</a>
                                                            </h4>
                                                        </div>
                                                        <div class='col-md-5'>
                                                            <div style='font-weight: normal;font-family:Arial, sans-serif;font-size: 13px;line-height:1.2;'>`+val3.description+`</div>
                                                        </div>`;
                                ...
                                out += `            </div>
                                                ...
                                                <div id='collapse-`+count+`' class='panel-collapse collapse'>
                                                    <div style='padding:10px;background-color:#E7E7E7'>
                                                        ...
                                                        <div class='panel-body'>`+val3.path+`</div>
                                                    </div>
                                                    </br>`;
